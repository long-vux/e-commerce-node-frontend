...
function ProductCard ({ product }) {
  ...
  const { name, price, image, totalSold, _id } = product
  ...
  return (
    <div
      className='relative p-4 rounded-2xl bg-white shadow-lg hover:scale-105 transition-all duration-300 cursor-pointer'
