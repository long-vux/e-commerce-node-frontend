...
const products = [
  {
    ...
    "price": 99.99,
    "image": "http://localhost:3001/static/media/item5-1.506f4605917d1b5ddddf.png",
...
const Home = () => {
  ...
  return (
    <div className='w-full h-full bg-fixed bg-cover bg-no-repeat bg-center' style={{ backgroundImage: `url(${bg})` }}>
